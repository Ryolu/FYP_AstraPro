...
public class GalleryControl1 : MonoBehaviour
{
    ...
    // Creates "Gallery"
    // Let every image listen for click
    // Listen for gesture
    void Start()
    {
        ...
        for (int p = 0; p < numberOfPages; p++)
        {
            ...
            for (int i = 0; i < imagesOnCurrentPage; i++)
            {
                ...
                ImageItem1 currentImageItem = currentItem.GetComponent<ImageItem1>();
    ...
    // Handles click event of images
    private void CurrentImageItem_OnClick(ImageItem1 currentItem)
    {
        // Change to View mode
    ...
    private void Update()
    {
        switch (currentViewMode)
        {
            ...
            case ViewMode.Preview:
                ...
                // Return to "Gallery" page (Zoom out for PreView)
                if (animated)
                {
                    if (t > 0)
                    {
    ...
    private void NuitrackManager_onNewGesture(nuitrack.Gesture gesture)
    {
        switch (currentViewMode)
        {
            ...
            case ViewMode.Preview:
                ...
                // Return to PreView mode & trigger Zoom out
            case ViewMode.View:
